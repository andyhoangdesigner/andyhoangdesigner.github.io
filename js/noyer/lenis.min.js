  ...
  (e = function () {
    ...
    class VirtualScroll {
      ...
      onWheel = (t) => {
        ...
        this.normalizeWheel && ((e = r(-100, e, 100)), (i = r(-100, i, 100))),
    ...
    return (
      ...
      class Lenis {
        ...
        set isSmooth(s) {
          t(this, i, 'f') !== s &&
            (e(this, i, s, 'f'), this.toggleClass('lenis-smooth', s));
        }
        get isScrolling() {
          return t(this, s, 'f');
        }
        set isScrolling(i) {
          t(this, s, 'f') !== i &&
            (e(this, s, i, 'f'), this.toggleClass('lenis-scrolling', i));
        }
        get isStopped() {
          return t(this, o, 'f');
        }
        set isStopped(i) {
          t(this, o, 'f') !== i &&
            (e(this, o, i, 'f'), this.toggleClass('lenis-stopped', i));
        }
        get isLocked() {
          return t(this, n, 'f');
        }
        set isLocked(i) {
          t(this, n, 'f') !== i &&
            (e(this, n, i, 'f'), this.toggleClass('lenis-locked', i));
        }
        get className() {
          let t = 'lenis';
          return (
